    ...
    <div>
        <div class="p-4  dark:border-gray-700">
            ...
            <div class="flex justify-between items-center">
                <button ata-modal-target="assignModal" data-modal-toggle="assignModal" class="cursor-pointer transition-all bg-blue-500 text-white px-6 py-2 rounded-lg
                        border-blue-600
            ...
            <div id="assignModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <!-- Modal body -->
                        <form action="./core/handler/assignhandler.php" method='POST'>
                            ...
                            <div
                                ...
                                <input type="submit" value='Assign'
                                    ...
                                    id="save">
                                <button data-modal-hide="assignModal" type="button"
